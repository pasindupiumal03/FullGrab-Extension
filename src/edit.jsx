                ...
                <div style={{ display: 'flex', flex: 1, overflow: 'hidden', height: 0 }}>
                    ...
                    <aside className="properties-panel" style={{
                        ...
                        <div style={{ padding: '20px', minHeight: 'min-content' }}>
                                    ...
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                        {['shadow', 'border', 'glow'].map(style => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    {style === 'shadow' && <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="7" height="7" /><rect x="14" y="3" width="7" height="7" /><rect x="14" y="14" width="7" height="7" /><rect x="3" y="14" width="7" height="7" /></svg>}
                                                    {style === 'border' && <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2" /></svg>}
                                                    {style === 'glow' && <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><line x1="12" y1="8" x2="12" y2="12" /><line x1="12" y1="16" x2="12.01" y2="16" /></svg>}
                            ...
                            {activeTool === 'shapes' && (
                                <div>
                                    ...
                                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '8px', marginBottom: '16px' }}>
                                        {[
                                            { name: 'Circle', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><circle cx="12" cy="12" r="10" /></svg> },
                                            { name: 'Square', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><rect x="3" y="3" width="18" height="18" rx="2" /></svg> },
                                            { name: 'Triangle', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 3 L22 21 L2 21 Z" /></svg> },
                                            { name: 'Star', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2 L15.09 8.26 L22 9.27 L17 14.14 L18.18 21.02 L12 17.77 L5.82 21.02 L7 14.14 L2 9.27 L8.91 8.26 Z" /></svg> },
                                            { name: 'Heart', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z" /></svg> },
                                            { name: 'Arrow', icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M12 4l-1.41 1.41L16.17 11H4v2h12.17l-5.58 5.59L12 20l8-8z" /></svg> }
                                        ].map(shape => (
                                            <button
                                                key={shape.name}
                                    ...
                                    {shapes.length > 0 && (
                                        <div style={{ marginBottom: '16px' }}>
                                            <div style={{ fontSize: '12px', fontWeight: 600, color: '#6b7280', marginBottom: '8px' }}>Layers ({shapes.length})</div>
                                            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                                                {shapes.map(shape => (
                                    ...
                                    {selectedShapeId && shapes.find(s => s.id === selectedShapeId) && (
                                        <div style={{
                                            ...
                                            <div style={{ marginBottom: '16px' }}>
                                                <div style={{ fontSize: '11px', fontWeight: 500, color: '#6b7280', marginBottom: '8px' }}>Size</div>
                                                <input
                                                    type="range"
                                                    min="20"
                                                    max="100"
                                            ...
                                            <div style={{ marginBottom: '16px' }}>
                                                <div style={{ fontSize: '11px', fontWeight: 500, color: '#6b7280', marginBottom: '8px' }}>Color</div>
                                                <input
                                                    type="color"
                                            ...
                                            <div style={{ marginBottom: '16px' }}>
                                                <div style={{ fontSize: '11px', fontWeight: 500, color: '#6b7280', marginBottom: '8px' }}>Rotation</div>
                                                <input
                                                    type="range"
                                                    min="0"
                                                    max="360"
                                            ...
                                            <div>
                                                <div style={{ fontSize: '11px', fontWeight: 500, color: '#6b7280', marginBottom: '8px' }}>Style</div>
                                                <div style={{ display: 'flex', gap: '8px' }}>
                                                    <button
                                                        ...
                                                        style={{
                                                            flex: 1,
                                                            padding: '8px',
                                                            background: shapes.find(s => s.id === selectedShapeId)?.style === 'filled' ? '#18181B' : 'white',
                                                    ...
                                                    <button
                                                        ...
                                                        style={{
                                                            flex: 1,
                                                            padding: '8px',
                                                            background: shapes.find(s => s.id === selectedShapeId)?.style === 'outline' ? '#18181B' : 'white',
                            ...
                            {activeTool === 'postout' && (
                                <div>
                                    <div style={{ fontSize: '13px', fontWeight: 600, color: '#374151', marginBottom: '16px' }}>Share to Social Media</div>
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                                        <button
                                        ...
                                        <div style={{ marginTop: '12px', padding: '12px', background: '#F3F4F6', borderRadius: '8px', fontSize: '11px', color: '#6B7280' }}>
                                            Note: This will upload your edited image to a public URL and open the sharing dialog.
                                        </div>
                                    </div>
                                </div>
                            )}
                        ...
                        <div style={{
                            ...
                            <div
                                ...
                                style={{
                                    ...
                                    borderRadius: '16px',
                                    boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25), 0 0 100px -20px rgba(0,0,0,0.1)',
